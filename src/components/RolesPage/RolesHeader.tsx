  ...
  return (
    <div className="p-6 border-b border-gray-200">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">{t("rolesPage.systemRoles.title")}</h3>
          <p className="text-sm text-gray-600">
            {t("rolesPage.systemRoles.subtitle")}
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          >
            <option value="All Status">{t("rolesPage.filters.allStatus")}</option>
          ...
          >
            ...
            {t("rolesPage.filters.createRole")}
          </button>
        </div>
      </div>
    </div>
